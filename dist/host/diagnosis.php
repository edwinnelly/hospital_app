...
<body class="font-ubuntu h_menu">
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1" style="text-transform: capitalize;"> Diagnosis History</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            ...
                            <button class="btn btn-warning hidden-xs ml-2" data-toggle="modal" data-target="#addPrescription" data-id="<?php echo (int) $get_staff_id;  ?>" id="pnt">Add Diagnosis</button>
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="border-top-0">Date of Onset</th>
                                                        <th class="border-top-0">Date Resolved</th>
                                                        <th class="border-top-0">Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                    $sql = "SELECT d.id, d.status, d.date_onset, d.date_resolved, l.test_name FROM diagnosis d JOIN lab_test_case l ON d.diagnosis_suffered = l.id WHERE d.patient_id = '$get_staff_id' ";
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        <li><a class="dropdown-item delete_emp" href="#" data-emp_name="<?php echo $fetch['test_name'] ?>" data-id="<?php echo $fetch['id'] ?>">Delete Diagnosis</a></li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                        </tr>
    ...
    <script>
        $(document).ready(function() {
            function validateForm() {
                let category_name = document.forms["myForm"]["date_onset"].value;
                if (category_name === "") {
                    Swal.fire({
    ...
    <script>
        $(document).on('click', '.discontinue', function() {
            ...
            const postid = $(this).attr("data-ids");
                ...
                $.ajax({
                    ...
                    success: (data) => {
                        if (data.trim() == "success") {
                            Swal.fire({
                                title: "success!",
                                text: "Updated, Please wait redirecting...!",
                                icon: "success",
                            });
                            setTimeout(function() {
                                location.reload();
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">New Diagnosis</h5>
            </div>
            <div class="modal-body">
                <form name="myForm" id="myForm" method="post">
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <p> <b>Status</b> </p>
                            <select class="form-control z-index show-tick" name="status"
                                data-live-search="true">
                        ...
                        <div class="form-group">
                            <label for="emp_name">Date Onset</label>
                            <input type="date" class="form-control" name="date_onset" required>

                        </div>
                        <div class="form-group">
                            <label for="emp_name">Date Resolved</label>
                            <input type="date" class="form-control" name="date_resolved" required>
...
<div class="modal fade" id="defaultModal_updates" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Update Diagnosis Status</h5>
            </div>
            <div class="modal-body">
                    ...
                    <div class="col-md-9">
                        <div class="form-group">
                            <select name="op" id="op">
                                <option value="" disabled>Diagnosis Status</option>
                                <option value="provisional">Provisional</option>
                                <option value="confirmed">Confirmed</option>
                                <option value="chronic">Chronic</option>
                                <option value="query">Query</option>
