    ...
    include "inc/rightside.php";
        ...
        <div class="body_area after_bg sm">
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1" style="text-transform: capitalize;"> Medical Report</h1>
                        </div>
                        <div class="col-lg-6 col-md-12 text-md-right">
                            <button class="btn btn-warning hidden-xs ml-2" data-toggle="modal" data-target="#addPrescription" data-id="<?php echo (int) $get_staff_id;  ?>" id="pnt">Create New Summary</button>
                                            ...
                                            <div class="body planned_task">
                                                <div class="dd" data-plugin="nestable">
                                                    <ol class="dd-list">
                                                        <?php
                                                        $fetch_user = "SELECT 
                medical_report.report_info,
                medical_report.doc_id,
                medical_report.id,
                medical_report.created_at,
            ...
            LEFT JOIN 
                staffs_accounts 
            ON 
            medical_report.doc_id = staffs_accounts.staff_id left join patient_data on medical_report.pid = patient_data.pid where medical_report.pid='$get_staff_id' order by medical_report.id desc  ";
        ...
        $(document).on('click', '.delete_emp', function() {
            ...
            $("#delete_emp").click(function() {
                ...
                if (id_del === '' || id_del === 0) {
                    ...
                    $.ajax({
                        url: "ajax/delete_medical_report",
                        method: "POST",
                        data: {
                            id_del: id_del
                        },
...
<div class="modal fade" id="addPrescription" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">New Summary Note</h5>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                <input type="submit" class="btn btn-success btn-simple waves-effect text-white" value="Create Summary" id="reset-btns">
