                ...
                <div class="menu">
                    <ul class="list">
                        ...
                        <li><a href="#" class="menu-toggle"><i class="zmdi zmdi-layers"></i><span>HMO</span></a>
                            <ul class="ml-menu">
                                <li><a href="userdir_hmo">Dashboard</a></li>
                        ...
                        <li><a href="#" class="menu-toggle"><i class="zmdi zmdi-layers"></i><span>Front Desk</span></a>
                            <ul class="ml-menu">
                                <li><a href="userdir_hmo">Dashboard</a></li>
                        ...
                        <li><a href="javascript:void(0);" class="menu-toggle"><i
                            ...
                            <ul class="ml-menu">
                                ...
                                <li><a href="ward_mgt.php">Wards Mgt</a></li>
