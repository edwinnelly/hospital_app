                ...
                <div class="container">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-6 col-md-12 text-md-right">
                            ...
                            <a href="add_patient_lab_profile.php?fid=<?php echo (int) $get_staff_id;  ?>"> <button class="btn btn-secondary hidden-xs ml-2">Created Drug Chart</button></a>
                        </div>
                    </div>
                </div>
            </div>
                                                            ...
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        <li><a class="dropdown-item" href="drug_chart.php">Chart Drug</a></li>
