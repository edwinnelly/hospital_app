...
<head>
    ...
    <title>Manage Discharge Summary</title>
    <!-- Favicon-->
                ...
                <div class="container">
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12">
                            ...
                            <h1 class="mb-1 mt-1">Discharge Summary</h1>
                        </div>
                        ...
                        <a href="patient_profile?fid=<?php echo $get_staff_id; ?>&&st=TWFya3NvbiBPIEhpbmxkYQ=="><button type="button" class="btn btn-sm" title="Time"><i class="icon-home" style="color:white"></i></button></a>
                            <button class="btn btn-secondary hidden-xs ml-2 addappoint"
                                data-id="<?php echo $get_staff_id; ?>">Create Summary</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card taskboard">
                            ...
                            <div class="body planned_task">
                                <div class="dd" data-plugin="nestable">
                                    ...
                                    <?php
                                    $fetch_user = "SELECT 
                                    discharge_summary.report_info,
                                    discharge_summary.doc_id,
                                    discharge_summary.id,
                                    discharge_summary.created_date,
                                ...
                                LEFT JOIN 
                                    staffs_accounts 
                                ON 
                                discharge_summary.doc_id = staffs_accounts.staff_id left join patient_data on discharge_summary.pid = patient_data.pid where discharge_summary.pid='$get_staff_id' order by discharge_summary.id desc  ";
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.trim() == 'success') {
                                ...
                                Swal.fire({
                                    title: "success!",
                                    text: "Summary Note Added, Please wait redirecting...!",
                                    icon: "success",
                                });
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.trim() == 'success') {
                                ...
                                Swal.fire({
                                    title: "success!",
                                    text: "Summary Deleted, Please wait redirecting...!",
                                    icon: "success",
                                });
                                setTimeout(function () {
                                    location.reload();
...
<div class="modal fade" id="delete_appoint" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="title" id="defaultModalLabel">Do you want To delete The discharge summary</summary></h5>
            </div>
            <div class="modal-body">
                <div class="col-md-6">
                    <div class="form-group">
