...
$ward = $app->post_request('ward');
$room = $app->post_request('room');
...
if (empty($room)) {
    ...
    $errors[] = "Room ID must be a number.";
}
...
if (empty($errors)) {
    $query = "INSERT INTO `admission` (`id`, `pid`, `tittle`, `description`, `appointment_date`, `doc_id`, `dated`,`specialist_id`,`assigned_doc_id`,`ward_id`,`room`) VALUES (NULL, '$id', '$tittle', '$description', '$timer', '$staff_ids', '$formattedDate','$specialist','$docid','$ward','$room')";
